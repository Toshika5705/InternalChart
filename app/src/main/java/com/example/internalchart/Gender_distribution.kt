...
class Gender_distribution : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.gender_distribution)
    ...
    private fun Parameter(d1: String, d2: String) {
       ...
       // val Getparameter = String.format("https://app.hugsys.com/api/group/getappchart/000001?key=NTkxOTE0ODlCRjZBNDlGRURCMTIzMDQ0QTRBQUFDMEE=&number=0&start=%s&end=%2s",
        //        d1, d2)
        val Getparameter = String.format("http://192.168.1.203:5000/api/V1/Analysis/quantity/NTkxOTE0ODlCRjZBNDlGRURCMTIzMDQ0QTRBQUFDMEE=/000000/0/"+d1+"/"+d2)
